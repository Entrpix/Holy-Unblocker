...
<p>Head to the 
    <a href="/pages/proxy/surf.html">Web Proxies</a> 
    page and select one of the proxies featured! Afterwards, type out the site you wish to access in the search box ("example.com").
</p>
<p>If you wish to explore the games featured on HU, check out the 
    <a href="/pages/games/gtools.html">game</a> 
    pages.
</p>
...
<p>- Rammerhead: Broad support for the majority of sites but slower (YouTube, now.gg, .io sites) 
<br>- Ultraviolet: Fast but has forward support for most sites (Discord, Bing and DuckDuckGo) </p>
<h2>Are all sites supported? Why are some sites not loading?</h2> 
<p>As advanced as they are, web proxies are not perfect. This means that some sites may not be supported by any of the proxies listed here due to limitations or security measures.</p>
